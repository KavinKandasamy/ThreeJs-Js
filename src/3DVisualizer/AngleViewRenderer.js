...
export default class AngleViewRenderer {
    ...
    setInstance()
    {
        ...
        //this.instance.setSize(window.innerWidth/2,window.innerHeight/2)
        //this.instance.setPixelRatio(Math.min(window.devicePixelRatio, 2))
        this.instance.setSize(this.threeDVisualizer.sizes.width/3, this.threeDVisualizer.sizes.height/2)
